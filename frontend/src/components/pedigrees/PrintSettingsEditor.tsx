...
export function PrintSettingsEditor() {
  ...
  // プレビュー用のサンプルデータ。実物血統書(WCA) と同じ英字+数字のみで構成。
  // 現物を参考にタイトル付きの祖先を複数混在させ、赤文字描画の確認もできるようにする。
  const getSamplePedigreeData = (): PedigreeData => ({
    catName: 'Legare Evelin',
    registrationNo: 'WCA NO. 0921382-704558',
    breed: 'Minuet(LH)',
    color: 'Cream Tabby',
    sex: 'Female',
    eyeColor: 'Gold',
    ...
    littersM: '1',
    littersF: '2',
    otherOrganizationsNo: '',
    sire: { name: 'Neko Labo Egbert', color: 'Blue Tabby', eyeColor: 'Gold', registrationNo: 'JCU-No 921381-170015' },
    dam: { name: "Jolly's Kare", color: 'Cream Tabby', eyeColor: 'Gold', registrationNo: 'WCA-No 941382-702247' },
    sireFather: { title: 'JCU GRC.', name: 'Ai Cat Cosmo', color: 'Cream Tabby', registrationNo: 'JCU-No 921381-152200' },
    sireMother: { name: 'Ai Cat Curea', color: 'Red Tabby-White', registrationNo: 'JCU-No 931862-137006' },
    damFather: { name: "Jorry's Daniel", color: 'Brown Tabby', registrationNo: 'JCU-No 841321-173013' },
    damMother: { name: "Jorry's Eve", color: 'Cream Tabby-White', registrationNo: 'JCU-No 561902-169305' },
    sireFatherFather: { title: 'JCU GRC.', name: 'Ai Cat Bryan', registrationNo: 'JCU-No 921841-131200' },
    sireFatherMother: { name: 'Hight Tree Daisy', registrationNo: 'JCU-No 931382-140708' },
    sireMotherFather: { name: 'Fountain House Grant', registrationNo: 'JCU-No 571921-112451' },
    sireMotherMother: { name: 'Hight Tree Andia', registrationNo: 'JCU-No 932032-115500' },
    damFatherFather: { name: 'Hight Tree Brest', registrationNo: 'JCU-No 440361-122194' },
    damFatherMother: { name: "Jorry's Cathy", registrationNo: 'JCU-No 562022-140001' },
    damMotherFather: { title: 'JCU GRC.', name: 'Ai Cat Bogart', registrationNo: 'JCU-No 571861-107745' },
    damMotherMother: { name: 'Fountain House Cherry', registrationNo: 'JCU-No 562042-113221' },
  });
